        ...
        <main className="flex-1">
          <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden">
            <div className="absolute inset-0 z-0">
              <img src={`${ASSET_BASE}/images/escadaria-luz.jpg`} alt="Escadaria em espiral iluminada por um facho de luz, simbolizando direção e relevância" className="w-full h-full object-cover" />
          ...
          <section className="relative py-24 overflow-hidden">
            <div className="absolute inset-0 z-0">
              <img src={`${ASSET_BASE}/images/cupula-jardim.jpg`} alt="Cúpula de vidro e vegetação sobre uma estrutura arquitetônica, simbolizando infraestrutura estratégica" className="w-full h-full object-cover" />
          ...
          <section className="relative py-28 overflow-hidden">
            <div className="absolute inset-0 z-0">
              <img src={`${ASSET_BASE}/images/silhueta-por-do-sol.jpg`} alt="Silhueta observando o pôr do sol sobre a cidade" className="w-full h-full object-cover" />
